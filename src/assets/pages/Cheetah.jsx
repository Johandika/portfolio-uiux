      ...
      <div className="container d-grid gap-4">
        ...
        <div className="row mx-auto">
          <figure className="col-12 text-center d-flex flex-column gap-2">
            <img src="public\img\Thumbnails4.png" alt="Cheetah_Portfolio" className="img-thumbnail" />
        ...
        <div className="row">
          <div className="col ">
            ...
            <p className="lh-lg">
              This project is the first development of the Cheetah Erje landing page website. Cheetah is a special
              division of the Nadwah Islamiyah Foundation which was established specifically to collect funds from all
              muhsinin who wish to donate. The funds collected will be distributed to 4 activity clusters under the
              auspices of the Nadwah Islamiyah foundation, namely the Raudhatul Jannah Pekanbaru Mosque, the Baitussalam
        ...
        <div className="row">
          <div className="col">
            <figure className="col-lg-6 col-10 text-center d-flex flex-column gap-2 mx-auto my-4">
              <img src="public\img\DRONE.gif" alt="GIF_Masjid_Raudhatul_Jannah" className="img-fluid" />
              <figcaption className="figure-caption">
                <em>
                  One of the clusters (out of 4 clusters) of the Nadwah Islamiyah Foundation, namely the Raudhatul
                  Jannah Islamic Center which was taken by drone
                </em>
              </figcaption>
            </figure>
          </div>
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="lh-lg">
              Cheetah has been running offline for several months and many new donors and potential donors have
              complained about the lack of information about Cheetah Erje and the steps for registering. At the same
              time, Cheetah Erje also wanted to create digital advertisements to introduce the "Autodebet Muhsinin"
              program through Facebook Ads and Instagram Ads, so a site was needed as a redirect for the Ads which will
              be broadcast in the near future. For this reason, the Cheetah team came to the conclusion of creating a
              Landing Page in blue tones that has complete information regarding the "Autodebit Muhsinin" program.
            </p>
          </div>
        </div>
        <div className="row">
          <div className="col">
            ...
            <p className="lh-lg">
              As I mentioned above, the main purpose of this site is to provide information for donors and potential
              donors, and it is also used for digital advertising needs to introduce "Cheetah" and Erje Cheetah's
              "Autodebet Muhsinin" program. So users on this site are donors and potential donors.
            </p>
            <div className="row">
              <figure className="col-lg-5 col-md-8 col text-center d-flex flex-column gap-2 mx-auto">
                <img src="public\img\user.jpg" alt="Users & Audiences" className="img-fluid" />
                <figcaption className="figure-caption">
        ...
        <div className="row">
          <div className="col">
            ...
            <ol className="lh-lg ">
              <li>
                Project Manager. I discuss with clients, get donor feedback from them, make project summaries, make
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="lh-lg">
              This is a website development project where a website is created from scratch. The Cheetah Erje team does
              not have a draft of the website content structure, does not collect assets, and I create the structure and
              design from scratch, so it requires more time and more intense discussion regarding the content structure.
              I also have to wait to get the latest photo assets from the ongoing activity cluster. So I developed the
              website structure from the information I received during the discussion. Luckily I got illustrations from
              friends in the illustrator community in Indonesia. The section list that I designed is:
              <ol className="lh-lg ">
            ...
            <p className="lh-lg">
              ...
              <ol className="lh-lg ">
                <li>
                  Send data from the form that has been filled in on the website to the Cheetah Erje admin email for
                  follow-up.
                </li>
        ...
        <div className="row">
          <div className="col">
            ...
            <p className="lh-lg">
              Since my client and I are in the same city, Pekanbaru, we decided to start the project by meeting at a
              Cheetah Erje office. Talk about the problem, objectives, scope and budget. These are the notes I took
              after the meeting :
              <ul>
                ...
                <li>Key words of design inspiration: design donation, design foundation, autodebit.</li>
              </ul>
            </p>
            <div className="row">
              <figure className="col-lg-5 col-md-8 col text-center d-flex flex-column gap-2 mx-auto">
                <img src="public\img\discussion.jpg" alt="Discussion_Cheetah" className="img-fluid" />
                <figcaption className="figure-caption">
